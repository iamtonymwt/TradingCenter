...
var file_service_simple_bank_proto_depIdxs = []int32{
	0, // 0: pb.tradingcenter.CreateUser:input_type -> pb.CreateUserRequest
	1, // 1: pb.tradingcenter.UpdateUser:input_type -> pb.UpdateUserRequest
	2, // 2: pb.tradingcenter.LoginUser:input_type -> pb.LoginUserRequest
	3, // 3: pb.tradingcenter.VerifyEmail:input_type -> pb.VerifyEmailRequest
	4, // 4: pb.tradingcenter.CreateUser:output_type -> pb.CreateUserResponse
	5, // 5: pb.tradingcenter.UpdateUser:output_type -> pb.UpdateUserResponse
	6, // 6: pb.tradingcenter.LoginUser:output_type -> pb.LoginUserResponse
	7, // 7: pb.tradingcenter.VerifyEmail:output_type -> pb.VerifyEmailResponse
